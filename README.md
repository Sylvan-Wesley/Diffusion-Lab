...
![random_images_diffusion_epoch_930](illustrations/random_images_diffusion_epoch_930.png)

### Conditional generation results

Examples of images generated by the model after 900 epochs of training: (using He's method)

![x_pred_class2_epoch_900](illustrations/x_pred_class2_epoch_900.png)

compared to images generated by the same network but using DDPM loss function after 900 epochs of training:

![x_pred_class2_epoch_900 vanilla](illustrations/x_pred_class2_epoch_900 vanilla.png)
